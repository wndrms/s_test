...
pub struct OverseasBalanceSummary {
    #[serde(default)]
    pub frcr_pchs_amt1: Option<String>, // 외화매입금액1
    #[serde(default)]
    pub ovrs_tot_pfls: Option<String>, // 해외총손익
    #[serde(default)]
    pub tot_evlu_pfls_amt: Option<String>, // 총평가손익금액
    #[serde(default)]
    pub tot_asst_amt: Option<String>, // 총자산금액
    #[serde(default)]
    pub excc_amt: Option<String>, // 정산금액 (예수금)
    #[serde(flatten)]
